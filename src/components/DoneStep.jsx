...
export default function DoneStep() {
  const { replSummary: summary, tgtCfg, restartMigration } = useMigration()
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '40px 0' }} className="animate-fade">
      ...
      <Btn onClick={restartMigration} variant="ghost" icon={<RefreshCw size={13} />}>Start New Migration</Btn>
